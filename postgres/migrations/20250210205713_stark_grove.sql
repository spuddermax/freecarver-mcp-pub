/*
  # Update User Access Functions
  
  1. Changes
    - Drop existing policies that depend on is_admin()
    - Recreate user view functions and types
    - Restore policies with updated functions
    
  2. Security
    - Maintains security definer settings
    - Preserves admin-only access controls
    - Keeps user-specific data restrictions
*/
