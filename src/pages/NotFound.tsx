      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Free Carver MCP</h1>
            <p className="text-gray-600 dark:text-gray-400">Master Control Program</p>
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-4">404 - Page Not Found</h2>
            <Bot className="h-32 w-32 dark:text-orange-400 mt-2 mx-auto" />
            <p className="text-gray-600 dark:text-gray-400 mt-2">Keep moving, program!</p>
            {session && (
              <Link to="/dashboard" className="mt-4 inline-block bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded">
                Go to Dashboard
              </Link>
            )}
